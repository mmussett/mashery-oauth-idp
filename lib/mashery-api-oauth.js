...
function mashlocalApiCall(req, callback) {
    ...
    var creds = "Basic " + new Buffer(props.mashlocalApiUsername + ":" + props.mashlocalApiPassword).toString("base64");
    ...
    var postReq = https.request(options, function (res) {
        ...
        res.on('data', function (chunk) {
            data += chunk;
            console.log("\n##### Response from Mashery Local API #####");
    ...
    console.log('Request data to Mashery Local API');
...
exports.fetchApplication = function (mashServiceKey, mashClientId, redirectUri, state, responseType, callback) {
    ...
    if (props.useMashlocal==false) {
        mashApiCall(req,callback);
    } else {
        mashlocalApiCall(req, callback);
    }
